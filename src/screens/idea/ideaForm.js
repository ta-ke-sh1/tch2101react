...
import { getCurrentDateAsDBFormat } from '../../utils/utils'
...
export default function IdeaForm({ props }) {
    ...
    async function handleSubmit(event) {
        ...
        formData.append('writer_id', 'trung');
        ...
        const response = await axios.post('http://localhost:5000/idea/add', formData, {
            headers: {
    ...
    return (<div className="model_box" style={
        {
            position: 'absolute',
            left: '50%',
            top: '50%',
            ...
            <Modal.Body>
                <form onSubmit={handleSubmit} encType="multipart/form-data">
                    ...
                    <div className="form-check form-switch mb-6">
                        <input className="form-check-input" type="checkbox" id="flexSwitchCheckDefault" onChange={(e) => setAnonymous(e.target.checked)} />
                        <label className="form-check-label" htmlFor="flexSwitchCheckDefault">Is anonymous?</label>
                    </div>
