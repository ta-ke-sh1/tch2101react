...
//             <b className="mb-2 capitalize">{idea.writer_id}</b>
//             <time dateTime={idea.post_date} className="text-gray-400 text-xs">{idea.post_date}
//             </time>
//           </div>
//         </div>
...
//         </div>
//       </div>
//       <div className="whitespace-pre-wrap mt-1 font-bold">{idea.title}</div>
//       <div className="whitespace-pre-wrap mt-7">{idea.content}</div>
