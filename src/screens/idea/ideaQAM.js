            ...
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              {currentIdeas.map((idea,index)=>(
                <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <td className="px-6 py-4">{idea.writer_id}</td>
                  <td className="px-6 py-4">{idea.approver_id}</td>
                  <td className="px-6 py-4">{idea.approved_date} </td>
                  <td className="px-6 py-4">{idea.title}</td>
                  <td className="px-6 py-4">{idea.category}</td>
                  <td className="px-6 py-4">{idea.thread}</td>
                  ...
                  <td className="px-6 py-4">{idea.post_date}</td>
                  {/* <td className="px-6 py-4">{idea.is_anonymous}</td> */}
                </tr>
